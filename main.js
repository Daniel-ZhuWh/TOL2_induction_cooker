...
function updateProg(){
    $('#dot'+current_q).addClass('dot_covered');
    if (current_q < q_num -1){
        $('#bar'+current_q).addClass('bar_covered');
    }
}
...
function renderProgress(num){
    for(var i=0; i<num-1; i++){
        document.getElementById('progress').innerHTML += "<div class='prog dot' id='dot"+i+"'></div>";
        document.getElementById('progress').innerHTML += "<div class='prog bar' id='bar"+i+"'></div>"
    }
    document.getElementById('progress').innerHTML += "<div class='prog dot' id='dot"+(num-1)+"'></div>";
}
...
function next(el){
    ...
    if (next == '#video'){
        ...
        $('#next_q_btn').fadeIn();
        $('.dot').removeClass('dot_covered');
        $('.bar').removeClass('bar_covered');
...
//        $('#next_in_dis').fadeIn();
    ...
    if (next.includes('self_prompt')){
        document.getElementById('prompt1').innerHTML = prompts[part-1][0];
        document.getElementById('prompt2').innerHTML = prompts[part-1][1];
    }
}
...
$(document).ready(function(){
    ...
    $(".next_assess").click(function(){
        ...
        $("#assessment").fadeIn(function(){
            ...
            var q_num = q_set.q_num;
            if (!prog_rendered){
                renderProgress(q_num);
                prog_rendered = true;
            }
        });        
    });
